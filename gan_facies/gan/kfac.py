...
class KFAC(Optimizer):
    ...
    def __init__(self, net, damping, pi=False, T_cov=1, T_inv=1,
                 alpha=1.0, constraint_norm=False,clipping=1.0):
        
        """ 
        Inspired from https://github.com/Thrandis/EKFAC-pytorch.
        
        K-FAC Preconditionner for Linear, Conv2d layers and ConvTranspose2d.
        ...
        Args:
            ...
            T_cov (int): Frequence of computing kronecker factors
            
            T_inv (int): Fequence of computing inverse of the approximate Fisher
            ...
            clipping (float): parameter for kl gradient clipping
        """
